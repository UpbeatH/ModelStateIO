...
required = ["18 trials", "six per mode", "equal-information", "actions", "wall-clock budget", "time-to-first-exact-ok", "robust-cv", "0.15", "no-go", "fresh read-only host/gpu audit"]
