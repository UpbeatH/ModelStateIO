...
- I001 installation audit is `BLOCKED`: no CUDA toolkit/nvcc or controllable llama.cpp runtime, and no second approved model. No system dependency or service change was performed.
