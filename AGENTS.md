...
`PFSOpt/environment/HPC-STACK` is a Lustre/PFS-line dependency record. It does
not govern ModelStateIO single-node work. ModelStateIO must maintain its own
runtime, CUDA/driver compatibility, model provenance, and installation record;
do not install or change Lustre client software for this line.
